...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "An application for restaurant cashiers/managers.  Custom menus, login tracking, and scheduling system."
      ForeColor       =   &H00000000&
      Height          =   1170
      Left            =   1050
      TabIndex        =   3
   ...
   Begin VB.Label lblTitle 
      Caption         =   "Restaurant Menu/Calculator"
      ForeColor       =   &H00000000&
      Height          =   480
      Left            =   1050
      TabIndex        =   5
...
Const KEY_ALL_ACCESS = KEY_QUERY_VALUE + KEY_SET_VALUE + KEY_CREATE_SUB_KEY + _
...
Public Sub StartSysInfo()
    ...
    If GetKeyValue(HKEY_LOCAL_MACHINE, gREGKEYSYSINFO, gREGVALSYSINFO, _
            SysInfoPath) Then
...
'------------------------------------------------------------
    rc = RegQueryValueEx(hKey, SubKeyRef, 0, KeyValType, tmpVal, KeyValSize) _
